...
import com.rmq.service.EventSubscriber;
...
public class EventSubscriberConfiguration implements ApplicationListener<ApplicationReadyEvent> {
	...
	public Queue eventReceivingQueue() {
		if(queueName == null) {
			throw new IllegalStateException("No queue to listen to! Please specify the name of the queue to listen to with property 'subscriber.queue'");
		}
